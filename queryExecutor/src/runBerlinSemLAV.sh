...
sed -i".bkp" "s/visualization=[a-z]*/visualization=$visualization/" configD.properties
for setup in $SETUPS ;do
    ...
    for i in $QUERIES ;do
        for j in `seq 1 $n` ;do
            ...
            java -XX:MaxHeapSize=${MEMSIZE2} processAnswersSemLAVFast $SemLAVPATH/expfiles/berlinOutput/$DATASET/$setup/outputSemLAVquery${i}_${MEMSIZE}_exec${j}/NOTHING $SemLAVPATH/expfiles/berlinData/$DATASET/answers/query${i} ${withPR}
        done
    done
done
